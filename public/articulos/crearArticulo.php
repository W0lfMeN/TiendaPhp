    ...
    <div class="container mt-3">
        <div class="bg-success p-4 text-white rounded shadow-lg mx-auto" style="width:48rem">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" placeholder="Articulo" name="nombre" require>
                <?php
            ...
            <div class="mb-3">
                ...
                <input type="number" step="any" class="form-control" id="precio" placeholder="Precio" name="precio" require>
                <?php
