<?php
    ...
    function hayError($name, $description){
        ...
        //Comprobamos que el nombre no exista ya en la base de datos
        if(!(new Categorias)->existeCategoria($name)){
           $error=true;
    ...
    if(isset($_POST['btnCrear'])){
        ...
        if($error==false){
            //Si entra aqui quiere decir que todo está OK, procedemos a crear la categoria
    ...
    <div class="container mt-3">
        <div class="bg-success p-4 text-white rounded shadow-lg mx-auto" style="width:48rem">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" placeholder="Categoria" name="nombre" require>
                <?php
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="description" rows="3" placeholder="Datos de la categoria" name="descripcion"></textarea>
                <?php
